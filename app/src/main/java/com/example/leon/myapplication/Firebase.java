...
//hTov5AvyN9h63Lsz4FRuCFCU2Msh9K94pdCehN4u
    public Firebase(String key, String url) {
    ...
    private void addStudentToList(String number) {
        ...
        System.out.println("This is the all_students content:\n"+element.toString()+"\n");
        if (element.toString().equalsIgnoreCase("null")) {
            this.driver.setChannel("all_students");
            HashMap<String, String> tt = new HashMap<>();
            System.out.println("Failed as all students was null");
            tt.put("0",number);
...
//        return this.driver.write(data);
    ...
    public static void main(String[] args) {
        Firebase firebase = new Firebase("ItxR5i7mQ5TQjRGNzWlq8KC4dqWtVdT3OQ3weuYI", "https://clubattendancesjam.firebaseio.com/");
        Random r = new Random();
